...
int main()
{
...

    {
        ...
        std::cout << it.query() << '\n'; // outputs "AAC"
        auto uni_it = it.get_fwd_iterator(); // unidirectional iterator on the text "GAATTAACGAAC"
...

    {
        ...
        it.extend_right("AAC"_dna4); // search the sequence "AAC"
        std::cout << it.query() << '\n'; // outputs "AAC"
        auto uni_it = it.get_rev_iterator(); // unidirectional iterator on the text "CAAGCAATTAAG"
        std::cout << uni_it.query() << '\n'; // outputs "CAA"
