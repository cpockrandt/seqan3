...
constexpr uint64_t genome_len{500'000'000};
...
//
//         std::filesystem::path p1{"/home/pocki/Downloads/murphy10.fa"};
...
//
//         // sample reads
//         std::filesystem::path p2{"/home/pocki/Downloads/reads.fa"};
...
//         fm_index wt(genome);
//
//         std::filesystem::path p3{"/home/pocki/Downloads/index.wt"};
...
//
//         std::filesystem::path p4{"/home/pocki/Downloads/index.epr"};
...
static void fm_index_wt_benchmark(benchmark::State& state) {
    sequence_file_input<sequence_file_input_default_traits_aa10> fin{"/home/pocki/Downloads/reads.fa"};
...
static void fm_index_epr_benchmark(benchmark::State& state) {
    ...
    std::filesystem::path p3{"/home/pocki/Downloads/index.epr"};
    std::ifstream os{p3, std::ios::binary};
    cereal::BinaryInputArchive iarchive{os};
    iarchive(epr);
